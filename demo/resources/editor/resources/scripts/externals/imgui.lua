...
if not pcall(ffi.typeof, "ImVec2") then ffi.cdef(cdecl) end


--load dll (or in our case, statically linked symbols)
local lib = setmetatable({}, {
    __index = function(t, k)
        local success, val = pcall(function() return ffi.C[k] end)
        if success then return val end
        return function() error("Symbol " .. tostring(k) .. " is not available in the statically linked cimgui!") end
    end
})
