...
function history.undo()
  if history.actions_index == 0 then return end
...
function history.redo()
  if history.actions_index >= #history.actions_stack then return end
...
function history.run_test()
  ...
  local action1 = Action.new(
    function() log_trace("redo1") end,
    function() log_trace("undo1") end,
    true
  )
  ...
  local action_g1 = Action.new(function() log_trace("redo_g1") end, function() log_trace("undo_g1") end, true)
  local action_g2 = Action.new(function() log_trace("redo_g2") end, function() log_trace("undo_g2") end, false)
  local action_g3 = Action.new(function() log_trace("redo_g3") end, function() log_trace("undo_g3") end, false)
  ...
  if #trace == 3 and trace[1] == "undo_g3" and trace[2] == "undo_g2" and trace[3] == "undo_g1" and history.actions_index == 0 then
  ...
  if #trace == 3 and trace[1] == "redo_g1" and trace[2] == "redo_g2" and trace[3] == "redo_g3" and history.actions_index == 3 then
  ...
  -- Group A
  local act_a1 = Action.new(function() log_trace("redo_a1") end, function() log_trace("undo_a1") end, true)
  local act_a2 = Action.new(function() log_trace("redo_a2") end, function() log_trace("undo_a2") end, false)
  -- Group B
  local act_b1 = Action.new(function() log_trace("redo_b1") end, function() log_trace("undo_b1") end, true)
  local act_b2 = Action.new(function() log_trace("redo_b2") end, function() log_trace("undo_b2") end, false)
