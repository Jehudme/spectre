...
prefabs_serialize_entity(ecs_world_t *entity_world, ecs_entity_t entity);
static void prefabs_deserialize_entity(ecs_world_t *entity_world,
                                       ecs_entity_t target,
                                       sandbox_properties_handle_t props);
static void prefabs_register_prefab(ecs_world_t *entity_world, const char *name,
                                    sandbox_properties_handle_t props);
...
static ecs_entity_t prefabs_find_prefab(ecs_world_t *entity_world,
                                        const char *name);
static ecs_entity_t
prefabs_create_entity_from_props(ecs_world_t *entity_world,
                                 sandbox_properties_handle_t props);
static ecs_entity_t prefabs_create_entity_from_prefab(ecs_world_t *entity_world,
                                                      ecs_entity_t prefab);
static ecs_entity_t prefabs_create_entity_from_name(ecs_world_t *entity_world,
                                                    const char *name);
...
SANDBOX_DEFINE_SERVICE(spectre_prefabs_service_t, spectre_prefabs_api_t,
                       &g_prefabs_api)
...
prefabs_serialize_entity(ecs_world_t *entity_world, ecs_entity_t entity) {
  ...
  auto *module =
      flecs_world.lookup("spectre::modules::prefabs_module_t").is_valid()
          ? flecs_world.try_get_mut<spectre::modules::prefabs_module_t>()
          : nullptr;
  if (module) {
    sandbox::properties props =
        module->serialize_entity(flecs_world.entity(entity));
...
static void prefabs_deserialize_entity(ecs_world_t *entity_world,
  ...
  auto *module =
      flecs_world.lookup("spectre::modules::prefabs_module_t").is_valid()
          ...
          : nullptr;
  if (module)
    module->deserialize_entity(flecs_world.entity(target),
                               sandbox::properties(props, false));
}

static void prefabs_register_prefab(ecs_world_t *entity_world, const char *name,
                                    sandbox_properties_handle_t props) {
  if (!entity_world || !name)
    return;
  flecs::world flecs_world(entity_world);
  auto *module =
      flecs_world.lookup("spectre::modules::prefabs_module_t").is_valid()
          ...
          : nullptr;
  if (module)
    module->register_prefab(name, sandbox::properties(props, false));
}
...
static ecs_entity_t prefabs_find_prefab(ecs_world_t *entity_world,
  ...
  auto *module =
      flecs_world.lookup("spectre::modules::prefabs_module_t").is_valid()
          ...
          : nullptr;
  if (module)
    return module->find_prefab(name).id();
  return 0;
}
...
prefabs_create_entity_from_props(ecs_world_t *entity_world,
  ...
  auto *module =
      flecs_world.lookup("spectre::modules::prefabs_module_t").is_valid()
          ...
          : nullptr;
  if (module)
    return module->create_entity(sandbox::properties(props, false)).id();
  return 0;
}
...
static ecs_entity_t prefabs_create_entity_from_prefab(ecs_world_t *entity_world,
  ...
  auto *module =
      flecs_world.lookup("spectre::modules::prefabs_module_t").is_valid()
          ...
          : nullptr;
  if (module)
    return module->create_entity(flecs_world.entity(prefab)).id();
  return 0;
}
...
spectre_prefabs_serialize_entity(ecs_world_t *world, ecs_entity_t entity) {
#ifdef __cplusplus
  flecs::world flecs_world(world);
  const spectre_prefabs_service_t *service =
      flecs_world.try_get<spectre_prefabs_service_t>();
#else
  const spectre_prefabs_service_t *service =
      (const spectre_prefabs_service_t *)ecs_singleton_get(
  ...
  if (service && service->api && service->api->serialize_entity) {
    ...
    sandbox::modules::logs::error(flecs_world,
                                  "[Prefabs Module] Service not initialized!");
  }
  return prefabs_serialize_entity(world, entity);
}

void spectre_prefabs_deserialize_entity(ecs_world_t *world, ecs_entity_t target,
                                        sandbox_properties_handle_t props) {
#ifdef __cplusplus
  flecs::world flecs_world(world);
  const spectre_prefabs_service_t *service =
...
void spectre_prefabs_register_prefab(ecs_world_t *world, const char *name,
                                     sandbox_properties_handle_t props) {
#ifdef __cplusplus
  flecs::world flecs_world(world);
  const spectre_prefabs_service_t *service =
...
ecs_entity_t
spectre_prefabs_create_entity_from_props(ecs_world_t *world,
                                         sandbox_properties_handle_t props) {
#ifdef __cplusplus
  flecs::world flecs_world(world);
  const spectre_prefabs_service_t *service =
...
ecs_entity_t spectre_prefabs_create_entity_from_prefab(ecs_world_t *world,
                                                       ecs_entity_t prefab) {
#ifdef __cplusplus
  flecs::world flecs_world(world);
  const spectre_prefabs_service_t *service =
...
ecs_entity_t spectre_prefabs_create_entity_from_name(ecs_world_t *world,
                                                     const char *name) {
#ifdef __cplusplus
  flecs::world flecs_world(world);
  const spectre_prefabs_service_t *service =
...
sandbox_properties_handle_t
prefabs::serialize_entity(const flecs::world &entity_world,
                          ecs_entity_t entity) {
  return spectre_prefabs_serialize_entity(entity_world.c_ptr(), entity);
}

void prefabs::deserialize_entity(const flecs::world &entity_world,
                                 ecs_entity_t target,
                                 sandbox_properties_handle_t props) {
  spectre_prefabs_deserialize_entity(entity_world.c_ptr(), target, props);
}

void prefabs::register_prefab(const flecs::world &entity_world,
                              const char *name,
                              sandbox_properties_handle_t props) {
  spectre_prefabs_register_prefab(entity_world.c_ptr(), name, props);
}
...
ecs_entity_t prefabs::find_prefab(const flecs::world &entity_world,
                                  const char *name) {
  return spectre_prefabs_find_prefab(entity_world.c_ptr(), name);
}

ecs_entity_t
prefabs::create_entity_from_props(const flecs::world &entity_world,
                                  sandbox_properties_handle_t props) {
  return spectre_prefabs_create_entity_from_props(entity_world.c_ptr(), props);
}

ecs_entity_t
prefabs::create_entity_from_prefab(const flecs::world &entity_world,
                                   ecs_entity_t prefab) {
  return spectre_prefabs_create_entity_from_prefab(entity_world.c_ptr(),
                                                   prefab);
}

ecs_entity_t prefabs::create_entity_from_name(const flecs::world &entity_world,
                                              const char *name) {
