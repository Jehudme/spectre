...
public:
  ...
  // We use the updated service/API structure here to register serializers
  // across modules
  void register_serializer(std::string_view serializer_type,
  ...
  sandbox::properties serialize_entity(flecs::entity serializer_entity,
                                       flecs::entity target_entity);
  void deserialize_entity(flecs::entity serializer_entity,
                          flecs::entity target_entity,
