...
static void serializer_register_serializer(ecs_world_t* entity_world, const char* type,
...
static sandbox_properties_handle_t serializer_serialize_entity(ecs_world_t* entity_world, ecs_entity_t serializer,
                                                               ecs_entity_t entity);
static void serializer_deserialize_entity(ecs_world_t* entity_world, ecs_entity_t serializer, ecs_entity_t entity,
...
static void serializer_deserialize_entity(ecs_world_t* entity_world, ecs_entity_t serializer, ecs_entity_t target,
                                          sandbox_properties_handle_t props) {
    if (!entity_world)
        return;
    flecs::world flecs_world(entity_world);
...
#else
    const spectre_serializer_service_t* service = (const spectre_serializer_service_t*)ecs_singleton_get(
...
SPECTRE_API void spectre_serializer_deserialize_entity(ecs_world_t* world, ecs_entity_t serializer, ecs_entity_t target,
                                           sandbox_properties_handle_t props) {
#ifdef __cplusplus
    flecs::world flecs_world(world);
    const spectre_serializer_service_t* service = flecs_world.try_get<spectre_serializer_service_t>();
...
void serializer::register_serializer(const flecs::world& entity_world, const char* type,
                                     const spectre_serializer_component* serializer) {
...
sandbox_properties_handle_t serializer::serialize_entity(const flecs::world& entity_world, ecs_entity_t serializer,
                                                         ecs_entity_t entity) {
    return spectre_serializer_serialize_entity(entity_world.c_ptr(), serializer, entity);
}

void serializer::deserialize_entity(const flecs::world& entity_world, ecs_entity_t serializer, ecs_entity_t target,
                                    sandbox_properties_handle_t props) {
