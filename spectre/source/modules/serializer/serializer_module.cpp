...
flecs::entity serializer_module::find_serializer(std::string_view serializer_type) const {
    ...
    if (!serializer_entity.is_valid()) {
        sandbox::modules::logs::trace(const_cast<flecs::world&>(m_world), "Serializer for type '{}' not found.",
                                      serializer_type);
    }
...
sandbox::properties serializer_module::serialize_entity(flecs::entity serializer_entity, flecs::entity target_entity) {
    ...
    if (serializer_component == nullptr || serializer_component->serialize == nullptr) {
        sandbox::modules::logs::error(m_world, "Failed to serialize entity: serializer "
...
void serializer_module::deserialize_entity(flecs::entity serializer_entity, flecs::entity target_entity,
    ...
    if (serializer_component == nullptr || serializer_component->deserialize == nullptr) {
        sandbox::modules::logs::error(const_cast<flecs::world&>(m_world), "Failed to deserialize entity: serializer "
