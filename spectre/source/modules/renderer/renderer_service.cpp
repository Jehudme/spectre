...
static void renderer_deserialize_renderer(ecs_world_t *entity_world,
                                          ecs_entity_t target,
                                          sandbox_properties_handle_t props);
static sandbox_properties_handle_t
renderer_serialize_renderer(ecs_world_t *entity_world, ecs_entity_t renderer);
static void renderer_register_renderer(ecs_world_t *entity_world,
                                       sandbox_properties_handle_t props);
...
SANDBOX_DEFINE_SERVICE(spectre_renderer_service_t, spectre_renderer_api_t,
                       &g_renderer_api)
...
static void renderer_deserialize_renderer(ecs_world_t *entity_world,
  ...
  auto *module =
      flecs_world.lookup("spectre::modules::renderer_module_t").is_valid()
          ? flecs_world.try_get_mut<spectre::modules::renderer_module_t>()
          : nullptr;
  if (module)
    module->deserialize_renderer(flecs_world.entity(target),
...
renderer_serialize_renderer(ecs_world_t *entity_world, ecs_entity_t renderer) {
  ...
  if (module) {
    sandbox::properties props =
        module->serialize_renderer(flecs_world.entity(renderer));
...
static void renderer_register_renderer(ecs_world_t *entity_world,
  ...
  auto *module =
      flecs_world.lookup("spectre::modules::renderer_module_t").is_valid()
          ...
          : nullptr;
  if (module)
    module->register_renderer(sandbox::properties(props, false));
}
...
static bool renderer_is_renderer(ecs_world_t *entity_world) {
  ...
  auto *module =
      flecs_world.lookup("spectre::modules::renderer_module_t").is_valid()
          ...
          : nullptr;
  if (module)
    return module->is_renderer();
  return false;
}

// --- Public C API Implementations ---
void spectre_renderer_deserialize_renderer(ecs_world_t *world,
                                           ecs_entity_t target,
                                           sandbox_properties_handle_t props) {
#ifdef __cplusplus
  flecs::world flecs_world(world);
  const spectre_renderer_service_t *service =
      flecs_world.try_get<spectre_renderer_service_t>();
#else
  const spectre_renderer_service_t *service =
      (const spectre_renderer_service_t *)ecs_singleton_get(
          world, spectre_renderer_service_t);
#endif
  if (service && service->api && service->api->deserialize_renderer) {
    ...
    sandbox::modules::logs::error(flecs_world,
                                  "[Renderer Module] Service not initialized!");
  }
  renderer_deserialize_renderer(world, target, props);
}

sandbox_properties_handle_t
spectre_renderer_serialize_renderer(ecs_world_t *world, ecs_entity_t renderer) {
#ifdef __cplusplus
  flecs::world flecs_world(world);
  const spectre_renderer_service_t *service =
      flecs_world.try_get<spectre_renderer_service_t>();
...
void spectre_renderer_register_renderer(ecs_world_t *world,
                                        sandbox_properties_handle_t props) {
#ifdef __cplusplus
  flecs::world flecs_world(world);
  const spectre_renderer_service_t *service =
...
void renderer::deserialize_renderer(const flecs::world &entity_world,
                                    ecs_entity_t target,
                                    sandbox_properties_handle_t props) {
...
sandbox_properties_handle_t
renderer::serialize_renderer(const flecs::world &entity_world,
                             ecs_entity_t renderer) {
  return spectre_renderer_serialize_renderer(entity_world.c_ptr(), renderer);
}

void renderer::register_renderer(const flecs::world &entity_world,
                                 sandbox_properties_handle_t props) {
