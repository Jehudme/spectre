...
public:
  ...
  bool has_script(std::string_view function_name,
                  const std::vector<script_argument_type_t> &args) const;
...
private:
  ...
  void execute_script_with_target(flecs::entity target,
                                  flecs::entity script_ent,
