...
static bool scripts_has_script(ecs_world_t *world, const char *function_name,
                               const spectre_script_argument_type_t *arg_types,
                               size_t arg_count) {
  ...
  std::vector<spectre_script_argument_type_t> types(arg_types,
                                                    arg_types + arg_count);
...
static ecs_entity_t scripts_find_script(ecs_world_t *world,
...
static void scripts_execute_script(ecs_world_t *world,
                                   const char *function_name,
                                   spectre_script_argument_t *args,
                                   size_t arg_count) {
  if (!world || !function_name)
    return;
  flecs::world fw(world);
...
scripts_serialize_scripts(ecs_world_t *world, ecs_entity_t entity) {
  if (!world || !entity)
    return {0};
  flecs::world fw(world);
  auto *module = fw.lookup("spectre::modules::script_module_t").is_valid()
...
static void
scripts_deserialize_scripts(ecs_world_t *world, ecs_entity_t target,
...
static void scripts_execute_on_destroy(ecs_world_t *world,
                                       ecs_entity_t entity) {
  if (!world || !entity)
    return;
  flecs::world fw(world);
...
static spectre_scripts_api_t api = {
    scripts_has_script,          scripts_is_script,
    scripts_find_script,         scripts_include_code,
    scripts_execute_script,      scripts_serialize_scripts,
    scripts_deserialize_scripts, scripts_execute_on_create,
    scripts_execute_on_destroy,  scripts_execute_on_update,
    scripts_execute_on_enter,    scripts_execute_on_exit};
...
ecs_entity_t spectre_scripts_find_script(ecs_world_t *world,
                                         const char *function_name) {
...
void spectre_scripts_execute_script(ecs_world_t *world,
                                    const char *function_name,
                                    spectre_script_argument_t *args,
                                    size_t arg_count) {
...
spectre_scripts_serialize_scripts(ecs_world_t *world, ecs_entity_t entity) {
  return scripts_serialize_scripts(world, entity);
}
void spectre_scripts_deserialize_scripts(
    ecs_world_t *world, ecs_entity_t target,
    sandbox_properties_handle_t props_handle) {
  scripts_deserialize_scripts(world, target, props_handle);
}

void spectre_scripts_execute_on_create(ecs_world_t *world,
                                       ecs_entity_t entity) {
  scripts_execute_on_create(world, entity);
}
void spectre_scripts_execute_on_destroy(ecs_world_t *world,
                                        ecs_entity_t entity) {
  scripts_execute_on_destroy(world, entity);
}
void spectre_scripts_execute_on_update(ecs_world_t *world,
                                       ecs_entity_t entity) {
