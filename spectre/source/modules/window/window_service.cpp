...
static void window_deserialize_window(ecs_world_t *world, ecs_entity_t target,
                                      sandbox_properties_handle_t props);
static sandbox_properties_handle_t
window_serialize_window(ecs_world_t *entity_world, ecs_entity_t window);
static void window_register_window(ecs_world_t *entity_world,
                                   sandbox_properties_handle_t props);
...
static void window_set_size(ecs_world_t *entity_world, uint32_t width,
                            uint32_t height);
static void window_set_position(ecs_world_t *entity_world, int32_t x,
                                int32_t y);
static void window_set_size_limits(ecs_world_t *entity_world,
...
static void window_set_always_on_top(ecs_world_t *entity_world,
                                     bool always_on_top);
...
SANDBOX_DEFINE_SERVICE(spectre_window_service_t, spectre_window_api_t,
                       &g_window_api)
...
static void window_deserialize_window(ecs_world_t *world, ecs_entity_t target,
  ...
  auto *module =
      flecs_world.lookup("spectre::modules::window_module_t").is_valid()
          ? flecs_world.try_get_mut<spectre::modules::window_module_t>()
          : nullptr;
  if (module)
    module->deserialize_window(flecs_world.entity(target),
...
window_serialize_window(ecs_world_t *entity_world, ecs_entity_t window) {
  ...
  if (module) {
    sandbox::properties props =
        module->serialize_window(flecs_world.entity(window));
...
static void window_register_window(ecs_world_t *entity_world,
  ...
  auto *module =
      flecs_world.lookup("spectre::modules::window_module_t").is_valid()
          ...
          : nullptr;
  if (module)
    module->register_window(sandbox::properties(props, false));
}
...
static void window_set_size_limits(ecs_world_t *entity_world, uint32_t min_w,
                                   uint32_t min_h, uint32_t max_w,
                                   uint32_t max_h) {
  if (!entity_world)
    return;
  flecs::world flecs_world(entity_world);
  auto *module =
      flecs_world.lookup("spectre::modules::window_module_t").is_valid()
          ...
          : nullptr;
  if (module)
    module->set_size_limits(min_w, min_h, max_w, max_h);
}
...
static float window_get_aspect_ratio(ecs_world_t *entity_world) {
  ...
  auto *module =
      flecs_world.lookup("spectre::modules::window_module_t").is_valid()
          ...
          : nullptr;
  if (module)
    return module->get_aspect_ratio();
  return 0.0f;
}
...
static void window_set_fullscreen(ecs_world_t *entity_world, bool fullscreen) {
  ...
  auto *module =
      flecs_world.lookup("spectre::modules::window_module_t").is_valid()
          ...
          : nullptr;
  if (module)
    module->set_fullscreen(fullscreen);
}
...
static void window_set_borderless(ecs_world_t *entity_world, bool borderless) {
  ...
  auto *module =
      flecs_world.lookup("spectre::modules::window_module_t").is_valid()
          ...
          : nullptr;
  if (module)
    module->set_borderless(borderless);
}
...
static void window_set_resizable(ecs_world_t *entity_world, bool resizable) {
  ...
  auto *module =
      flecs_world.lookup("spectre::modules::window_module_t").is_valid()
          ...
          : nullptr;
  if (module)
    module->set_resizable(resizable);
}
...
static void window_set_always_on_top(ecs_world_t *entity_world,
  ...
  auto *module =
      flecs_world.lookup("spectre::modules::window_module_t").is_valid()
          ...
          : nullptr;
  if (module)
    module->set_always_on_top(always_on_top);
}
...
static void window_set_cursor_visible(ecs_world_t *entity_world, bool visible) {
  ...
  auto *module =
      flecs_world.lookup("spectre::modules::window_module_t").is_valid()
          ...
          : nullptr;
  if (module)
    module->set_cursor_visible(visible);
}
...
static void window_set_cursor_locked(ecs_world_t *entity_world, bool locked) {
  ...
  auto *module =
      flecs_world.lookup("spectre::modules::window_module_t").is_valid()
          ...
          : nullptr;
  if (module)
    module->set_cursor_locked(locked);
}
...
static bool window_is_cursor_visible(ecs_world_t *entity_world) {
  ...
  auto *module =
      flecs_world.lookup("spectre::modules::window_module_t").is_valid()
          ...
          : nullptr;
  if (module)
    return module->is_cursor_visible();
  return false;
}
...
static bool window_is_cursor_locked(ecs_world_t *entity_world) {
  ...
  auto *module =
      flecs_world.lookup("spectre::modules::window_module_t").is_valid()
          ...
          : nullptr;
  if (module)
    return module->is_cursor_locked();
  return false;
}
...
static void *window_get_native_handle(ecs_world_t *entity_world) {
  ...
  auto *module =
      flecs_world.lookup("spectre::modules::window_module_t").is_valid()
          ...
          : nullptr;
  if (module)
    return module->get_native_handle();
  return nullptr;
}
...
static bool window_is_key_down(ecs_world_t *entity_world, int keycode) {
  ...
  auto *module =
      flecs_world.lookup("spectre::modules::window_module_t").is_valid()
          ...
          : nullptr;
  if (module)
    return module->is_key_down(keycode);
  return false;
}
...
static bool window_is_key_pressed(ecs_world_t *entity_world, int keycode) {
  ...
  auto *module =
      flecs_world.lookup("spectre::modules::window_module_t").is_valid()
          ...
          : nullptr;
  if (module)
    return module->is_key_pressed(keycode);
  return false;
}
...
static bool window_is_key_released(ecs_world_t *entity_world, int keycode) {
  ...
  auto *module =
      flecs_world.lookup("spectre::modules::window_module_t").is_valid()
          ...
          : nullptr;
  if (module)
    return module->is_key_released(keycode);
  return false;
}
...
static float window_get_mouse_delta_x(ecs_world_t *entity_world) {
  ...
  auto *module =
      flecs_world.lookup("spectre::modules::window_module_t").is_valid()
          ...
          : nullptr;
  if (module)
    return module->get_mouse_delta_x();
  return 0.0f;
}
...
static float window_get_mouse_delta_y(ecs_world_t *entity_world) {
  ...
  auto *module =
      flecs_world.lookup("spectre::modules::window_module_t").is_valid()
          ...
          : nullptr;
  if (module)
    return module->get_mouse_delta_y();
  return 0.0f;
}

// --- Public C API Implementations ---
void spectre_window_deserialize_window(ecs_world_t *world, ecs_entity_t target,
                                       sandbox_properties_handle_t props) {
#ifdef __cplusplus
  flecs::world flecs_world(world);
  const spectre_window_service_t *service =
      flecs_world.try_get<spectre_window_service_t>();
#else
  const spectre_window_service_t *service =
      (const spectre_window_service_t *)ecs_singleton_get(
          world, spectre_window_service_t);
#endif
  if (service && service->api && service->api->deserialize_window) {
    service->api->deserialize_window(world, target, props);
    return;
  } else {
    sandbox::modules::logs::error(flecs_world,
                                  "[Window Module] Service not initialized!");
  }
...
void spectre_window_register_window(ecs_world_t *world,
                                    sandbox_properties_handle_t props) {
#ifdef __cplusplus
  flecs::world flecs_world(world);
  const spectre_window_service_t *service =
...
void spectre_window_set_size(ecs_world_t *world, uint32_t width,
                             uint32_t height) {
#ifdef __cplusplus
  flecs::world flecs_world(world);
  const spectre_window_service_t *service =
...
void spectre_window_set_size_limits(ecs_world_t *world, uint32_t min_width,
  ...
  if (service && service->api && service->api->set_size_limits) {
    service->api->set_size_limits(world, min_width, min_height, max_width,
                                  max_height);
    return;
  } else {
    sandbox::modules::logs::error(flecs_world,
...
void window::deserialize_window(const flecs::world &entity_world,
                                ecs_entity_t target,
                                sandbox_properties_handle_t props) {
...
sandbox_properties_handle_t
window::serialize_window(const flecs::world &entity_world,
                         ecs_entity_t window) {
  return spectre_window_serialize_window(entity_world.c_ptr(), window);
}

void window::register_window(const flecs::world &entity_world,
                             sandbox_properties_handle_t props) {
...
void window::set_size(const flecs::world &entity_world, uint32_t width,
                      uint32_t height) {
  spectre_window_set_size(entity_world.c_ptr(), width, height);
}

void window::set_position(const flecs::world &entity_world, int32_t x,
                          int32_t y) {
  spectre_window_set_position(entity_world.c_ptr(), x, y);
}

void window::set_size_limits(const flecs::world &entity_world,
                             uint32_t min_width, uint32_t min_height,
                             uint32_t max_width, uint32_t max_height) {
  spectre_window_set_size_limits(entity_world.c_ptr(), min_width, min_height,
...
void window::set_always_on_top(const flecs::world &entity_world,
                               bool always_on_top) {
...
void window::set_cursor_visible(const flecs::world &entity_world,
                                bool visible) {
