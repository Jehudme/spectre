...
class serializer {
  public:
    static void register_serializer(const flecs::world& entity_world, const char* type,
    ...
    static sandbox_properties_handle_t serialize_entity(const flecs::world& entity_world, ecs_entity_t serializer,
                                                        ecs_entity_t entity);

    static void deserialize_entity(const flecs::world& entity_world, ecs_entity_t serializer, ecs_entity_t target,
