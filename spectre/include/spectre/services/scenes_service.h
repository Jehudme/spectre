...
typedef struct spectre_scenes_api_t {
  sandbox_properties_handle_t (*serialize_state)(ecs_world_t *world,
                                                 ecs_entity_t state);
  void (*deserialize_state)(ecs_world_t *world, ecs_entity_t target,
                            sandbox_properties_handle_t props);
  sandbox_properties_handle_t (*serialize_scene)(ecs_world_t *world,
                                                 ecs_entity_t scene);
  void (*deserialize_scene)(ecs_world_t *world, ecs_entity_t target,
                            sandbox_properties_handle_t props);
  ...
  void (*execute_recursive)(ecs_world_t *world, ecs_entity_t entity,
...
spectre_scenes_serialize_state(ecs_world_t *world, ecs_entity_t state);
SANDBOX_API void
spectre_scenes_deserialize_state(ecs_world_t *world, ecs_entity_t target,
                                 sandbox_properties_handle_t props);
SANDBOX_API sandbox_properties_handle_t
spectre_scenes_serialize_scene(ecs_world_t *world, ecs_entity_t scene);
SANDBOX_API void
spectre_scenes_deserialize_scene(ecs_world_t *world, ecs_entity_t target,
                                 sandbox_properties_handle_t props);
SANDBOX_API void
spectre_scenes_register_state(ecs_world_t *world,
                              sandbox_properties_handle_t props);
SANDBOX_API void
spectre_scenes_register_scene(ecs_world_t *world,
                              sandbox_properties_handle_t props);
SANDBOX_API ecs_entity_t spectre_scenes_find_state(ecs_world_t *world,
                                                   const char *name);
SANDBOX_API ecs_entity_t spectre_scenes_find_scene(ecs_world_t *world,
                                                   const char *name);
...
SANDBOX_API bool spectre_scenes_is_state(ecs_world_t *world,
                                         ecs_entity_t entity);
SANDBOX_API bool spectre_scenes_is_scene(ecs_world_t *world,
                                         ecs_entity_t entity);
...
SANDBOX_API void spectre_scenes_push_state(ecs_world_t *world,
                                           ecs_entity_t state);
SANDBOX_API void spectre_scenes_pop_state(ecs_world_t *world);
SANDBOX_API void
spectre_scenes_execute_recursive(ecs_world_t *world, ecs_entity_t entity,
                                 spectre_recursive_callback_t callback,
                                 void *payload);
