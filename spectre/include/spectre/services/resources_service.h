...
typedef struct spectre_resources_api_t {
  void (*deserialize_resource)(ecs_world_t *world, ecs_entity_t target,
                               sandbox_properties_handle_t props);
  sandbox_properties_handle_t (*serialize_resource)(
      ecs_world_t *world, ecs_entity_t resourceEntity);
  void (*register_resource_loader)(ecs_world_t *world, const char *type,
                                   spectre_resource_loader_component_t loader);
  void (*register_resource)(ecs_world_t *world,
                            sandbox_properties_handle_t props);
...
// --- Public C API ---
SANDBOX_API void
spectre_resources_deserialize_resource(ecs_world_t *world, ecs_entity_t target,
                                       sandbox_properties_handle_t props);
...
SANDBOX_API void spectre_resources_register_resource_loader(
    ...
    spectre_resource_loader_component_t loader);
SANDBOX_API void
spectre_resources_register_resource(ecs_world_t *world,
                                    sandbox_properties_handle_t props);
SANDBOX_API bool spectre_resources_has_resource_loader(ecs_world_t *world,
                                                       const char *type);
SANDBOX_API bool spectre_resources_has_resource(ecs_world_t *world,
                                                const char *name);
SANDBOX_API bool spectre_resources_is_resource(ecs_world_t *world,
                                               ecs_entity_t entity);
SANDBOX_API ecs_entity_t
spectre_resources_find_resource_loader(ecs_world_t *world, const char *type);
SANDBOX_API ecs_entity_t spectre_resources_find_resource(ecs_world_t *world,
                                                         const char *name);
SANDBOX_API bool spectre_resources_is_resource_loaded(ecs_world_t *world,
                                                      ecs_entity_t resource);
SANDBOX_API void spectre_resources_load_resource(ecs_world_t *world,
                                                 ecs_entity_t resourceEntity);
SANDBOX_API void spectre_resources_free_resource(ecs_world_t *world,
                                                 ecs_entity_t resourceEntity);
SANDBOX_API void *spectre_resources_get_resource(ecs_world_t *world,
                                                 ecs_entity_t resourceEntity);
