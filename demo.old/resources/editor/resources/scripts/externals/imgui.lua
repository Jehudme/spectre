...
void igEnd(void);
_Bool                igBeginChild_Str(const char* str_id,const ImVec2 size,                                                                    _Bool                                                                          border,ImGuiWindowFlags flags);
_Bool                igBeginChild_ID(ImGuiID id,const ImVec2 size,                                                           _Bool                                                                 border,ImGuiWindowFlags flags);
...
_Bool                igCombo_FnStrPtr(const char* label,int* current_item,const char*(*getter)(void* user_data,int idx),void* data,int items_count,int popup_max_height_in_items);
...
_Bool                igCollapsingHeader_BoolPtr(const char* label,                                                           _Bool                                                               * p_open,ImGuiTreeNodeFlags flags);
...
_Bool                igListBox_FnStrPtr(const char* label,int* current_item,                                                                      _Bool                                                                          (*items_getter)(void* data,int idx,const char** out_text),void* data,int items_count,int height_in_items);
...
_Bool                igIsKeyPressed_InputFlags(ImGuiKey key,int flags,ImGuiID owner_id);
_Bool                igIsKeyReleased_Nil(ImGuiKey key);
_Bool                igIsKeyReleased_ID(ImGuiKey key,ImGuiID owner_id);
_Bool                igIsKeyChordPressed_Nil(int key_chord);
_Bool                igIsKeyChordPressed_InputFlags(int key_chord,int flags,ImGuiID owner_id);
...
_Bool                igIsMouseClicked_InputFlags(ImGuiMouseButton button,int flags,ImGuiID owner_id);
